  ...
  return (
    <>
      <div className="position-left">
        <h1>Escape Room</h1>
        <div className="Esc">
          <img src="../client/styles/images/Esc1.png" alt="Esc1" />
          <img src="../client/styles/images/Esc2.png" alt="Esc2" />
        </div>
        <div className="Esc">
          <img src="../client/styles/images/Esc3.png" alt="Esc3" />
          <img src="../client/styles/images/Esc4.png" alt="Esc4" />
        </div>
        <p>
